  ...
  return (
    <div className={classes.productListWrapper}>
      <div className="container">
        <Typography variant="h1">AVAILABLE BOOKS</Typography>
              ...
              <div className="product-list" key={index}>
                <div className="product-list-inner">
                  ...
                  <div className="content-wrapper">
                    ...
                    <button className="MuiButtonBase-root MuiButton-root MuiButton-contained  MuiButton-containedPrimary MuiButton-disableElevation">
                      <span
